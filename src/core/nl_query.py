...
def validate_semantics(question: str, sql: str) -> None:
    ...
    if "round = 'f'" in sql_l or "round='f'" in sql_l:
        if not _question_mentions_finals_or_titles(question):
            raise ValueError(
    ...
    try:
        ...
        if "interrupted" in msg.lower():
            ...
            try:
                ...
                print("\n❌ Failed to simplify or execute simplified query.")
                print(str(simpl_err))
                return
        else:
